...
class ContextMenuBuilder {
    ...
    constructor(spellCheckHandler) {
        ...
        windowOrWebView = windowOrWebView || _electron.BrowserWindow.getFocusedWindow();
    ...
    showPopupMenu(contextInfo) {
        ...
        return _asyncToGenerator(function* () {
            ...
            if (!menu) return;
            menu.popup(_electron.BrowserWindow.getFocusedWindow(), { async: true });
        })();
    }
    ...
    buildMenuForLink(menuInfo) {
        ...
        let copyLink = new _electron.MenuItem({
        ...
        let openLink = new _electron.MenuItem({
    ...
    addSpellingItems(menu, menuInfo) {
        ...
        return _asyncToGenerator(function* () {
            ...
            let corrections = yield (0, _spellchecker.getCorrectionsForMisspelling)(menuInfo.selectionText);

            if (corrections && corrections.length) {
                corrections.forEach(function (correction) {
                    let item = new _electron.MenuItem({
                        label: correction,
                        click: function () {
            ...
            if (process.platform === 'darwin') {
                let learnWord = new _electron.MenuItem({
    ...
    addSearchItems(menu, menuInfo) {
        ...
        if (process.platform === 'darwin') {
            ...
            let lookUpDefinition = new _electron.MenuItem({
        ...
        let search = new _electron.MenuItem({
    ...
    addImageItems(menu, menuInfo) {
        let copyImage = new _electron.MenuItem({
        ...
        let copyImageUrl = new _electron.MenuItem({
    ...
    addInspectElement(menu, menuInfo) {
        ...
        let inspect = new _electron.MenuItem({
